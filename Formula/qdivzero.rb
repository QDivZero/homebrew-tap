class Qdivzero < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/QDivZero/qdivzero-cli/releases/download/v1.0.1/qdivzero_1.0.1_darwin_arm64.tar.gz"
      sha256 "4fde79ca56a2b56bdaa53fb1530f8ecd9585ffef3c6ed99fa2095cc9f3a46235"
    end
    on_intel do
      url "https://github.com/QDivZero/qdivzero-cli/releases/download/v1.0.1/qdivzero_1.0.1_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/QDivZero/qdivzero-cli/releases/download/v1.0.1/qdivzero_1.0.1_linux_arm64.tar.gz"
        sha256 "473e7f4dae269c694b04e5d49083e386f0da3c30c5f4b4923f920d6ceec33242"
      end
    end
    on_intel do
      url "https://github.com/QDivZero/qdivzero-cli/releases/download/v1.0.1/qdivzero_1.0.1_linux_amd64.tar.gz"
